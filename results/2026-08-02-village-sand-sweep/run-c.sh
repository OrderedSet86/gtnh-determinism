...
"$REPO/scripts/prefilter.sh" "random:150000:20260804" "$PWD/sweep-c.jsonl" > boot-sweep-c.log 2>&1
echo "SWEEP COMPLETE $(date)"

# Batch C: third 150k, RNG seed 20260804 (A=20260802 cut at 153941, B=20260803).
