...
"$REPO/scripts/prefilter.sh" "random:150000:20260803" "$PWD/sweep-b.jsonl" > boot-sweep-b.log 2>&1
echo "SWEEP COMPLETE $(date)"

# Batch B: second 150k, RNG seed 20260803 (batch A used 20260802 and was cut at 153941/1000000).
# A different RNG seed is required — reusing 20260802 would redraw the identical seed sequence.
# Rank A+B together: python3 ../../seedsearch/coke-rank.py <both files> --require paper,tic,furnace,sand --sand-cols 44
