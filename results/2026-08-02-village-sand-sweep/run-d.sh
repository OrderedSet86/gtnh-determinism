...
"$REPO/scripts/prefilter.sh" "random:150000:20260805" "$PWD/sweep-d.jsonl" > boot-sweep-d.log 2>&1
echo "SWEEP COMPLETE $(date)"

# Batch D: fourth 150k, RNG seed 20260805 (A=20260802, B=20260803, C=20260804).
